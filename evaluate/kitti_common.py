...
def to_kitti_format(annotations, path):
    n = len(annotations["name"])
    kitti_str = []
    for i in range(n):
        kitti_str.append('%s %.2f %d %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f' % (
            annotations['name'][i], annotations['truncated'][i], annotations['occluded'][i], annotations['alpha'][i],
            annotations['bbox'][i, 0], annotations['bbox'][i, 1], annotations['bbox'][i, 2], annotations['bbox'][i, 3],
            annotations['dimensions'][i, 1], annotations['dimensions'][i, 2], annotations['dimensions'][i, 0],
            annotations['location'][i, 0], annotations['location'][i, 1], annotations['location'][i, 2],
            annotations['rotation_y'][i], annotations['score'][i]))
