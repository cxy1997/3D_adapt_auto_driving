...
class GTDatabaseGenerator(KittiDataset):
    def __init__(self, root_dir, split='train', classes=args.class_name, subsample=-1, shuffle_subsample=None):
        super().__init__(root_dir, split=split, subsample=subsample, shuffle_subsample=shuffle_subsample)
